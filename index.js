...
const { smsg, isUrl, generateMessageTag, getBuffer, getSizeMedia, getRandom, fetchJson, await, sleep } = require('./lib/myfunc')
const question = (text) => {
...
if(usePairingCode && !ehz.authState.creds.registered) {
		const phoneNumber = await question('MASUKKAN NOMOR DENGAN AWALAN 62 UNTUK MENDAPATKAN PAIRING CODE || BUY SC CHAT 6281325828808\n');
 ...
 //=================================================//
   ehz.sendImageAsSticker = async (jid, media, m, options = {}) => {
    ...
    let jancok = new Sticker(media, {
        pack:"Rasolz°᭄ᴮᵒᵗ", // The pack name
        author:"Created By 𝐑𝐚𝐬𝐡𝐲𝐚",// The author name
  ...
  title:"Rasolz°᭄ᴮᵒᵗ",body: `${textT}`,previewType:"PHOTO",thumbnail: fs.readFileSync('./media/thumb.jpeg'),
  sourceUrl:'https://chat.whatsapp.com/F20Ia7iTt8JGBxRfaTGSr6'																																
...
connectToWhatsApp();
  ...
  ehz.sendMessage('6281325828808' + "@s.whatsapp.net", { text: `Hai Rashya Rasolz Botz Telah Aktif 
